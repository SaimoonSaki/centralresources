...
const BOOKS = [
  ...
  },
  {
    ...
    desc: "First recommended book, the solution for this edition: https://fliphtml5.com/vvba/anrl/Introduction_to_Chemical_Engineering_Thermodynamics_Solution_Manual/",
    featured: true,
    ...
    tags: ["thermodynamics", "thermo", "4th semester", "JM Smith","6th edition","Solution"]
  {
    ...
    desc: "solution required money, but you can preview in this website: https://www.slideshare.net/slideshow/vdocumentsmxthermodynamicsanengineeringapproach5thedsolutionpdf/266383992",
    featured: false,
